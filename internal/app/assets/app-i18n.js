const i18nMessages = {
  zh: {
    ...
    "setup.subtitle": "首次部署时先完成数据库检查和管理员账号初始化。",
    "setup.databaseReady": "数据库已初始化",
    "setup.databaseChecking": "正在检查数据库初始化状态",
    "nav.developer": "开发者视角",
    "nav.audit": "审计",
    "nav.refresh": "刷新",
    "nav.logout": "退出",
  ...
  en: {
    ...
    "setup.subtitle": "Complete database checks and administrator initialization before first use.",
    "setup.databaseReady": "Database initialized",
    "setup.databaseChecking": "Checking database initialization status",
